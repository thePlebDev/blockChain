...
class Blockchain(object):
    ...
    def register_node(self,address):
        ...
        :param adress: <str> address of node. Eg. 'http://192.168.0.5:5000'
        :return: None
        """
    ...
    def resolve_conflicts(self):
        ...
        #we are only looking for chains longer than ours max_length = len(self.chain)
        # Grab adn verify the chains from all the nodes in our network
        for node in neighbours:
            response = response.get(f'http://{nobel}/chain')
        ...
        #replace out chain if we discover a new, valid chain longer than ours
